...
class PomeriumVerifier {
    ...
    async verifyBrowserUser() {
        const jwt = await (0, utils_js_1.getClientJwt)();
    ...
    async verifyJwt(jwt) {
        ...
        const verified = await (0, utils_js_1.verifyPomeriumJWT)(jwt, (0, utils_js_1.withHttps)(this.issuer), this.issuer, this.audience);
