...
export declare const verifyPomeriumJWT: (jwt: string, authenticateBaseUrl: string, issuer: string, audience: string | string[]) => Promise<jose.JWTVerifyResult<jose.JWTPayload> & jose.ResolvedKey>;
